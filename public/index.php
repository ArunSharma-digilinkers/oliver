				...
				<div class="row">
					...
					<div class="col-lg-6 col-sm-12 info">
						<div class="">
							...
							<p>
							At Oliver Batteries, we don’t just deliver energy we deliver reliability. Whether you're at home, on the road, or driving change across cities, our high-performance batteries ensure your life stays powered without interruption.
							</p>
						</div>
						<div class="row">
							<div class="col-lg-12 col-sm-12">
								<div class="cards">
									...
									<div class="details">
										<p>
										From <strong>inverter batteries</strong> that protect your comfort during power cuts, to <strong>automotive batteries</strong> that fuel your journey, and <strong>E-rickshaw batteries</strong> that drive sustainable mobility we offer solutions that fit every lifestyle, every industry.
										</p>
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-lg-8 col-sm-12">
						<div class="cta-wrap">
							...
							<h3>
							Choose Oliver Inverter Batteries for uninterrupted energy and peace of mind to your home.
							</h3>
						</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-sm-12">
						<div class="why-list">
							...
							<div class="why-icon">
								<img src="<?php echo $path; ?>img/robotics.png" alt="eco icon"
									class="img-fluid" />
							</div>
						</div>
						<div class="why-list">
							...
							<div class="why-icon">
								<img src="<?php echo $path; ?>img/reliability.png" alt="eco icon"
									class="img-fluid" />
							</div>
						</div>
						<div class="why-list">
							...
							<div class="why-icon">
								<img src="<?php echo $path; ?>img/configuration.png" alt="eco icon"
									class="img-fluid" />
							</div>
						</div>
					...
					<div class="col-lg-4 col-sm-12">
						<div class="why-list">
							<div class="why-icon">
								<img src="<?php echo $path; ?>img/support.png" alt="eco icon"
									class="img-fluid" />
							</div>
							<div class="why-text">
						...
						<div class="why-list">
							<div class="why-icon">
								<img src="<?php echo $path; ?>img/operation.png" alt="eco icon"
									class="img-fluid" />
							</div>
							<div class="why-text">
								<h4>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-sm-12">
						...
						<p>
							Discover the perfect power partner for your needs with <strong>Oliver Batteries</strong>. From high-performance inverter batteries for seamless backup, to durable E-rickshaw and automotive solutions built for Indian roads our products are designed for <strong>reliability</strong>, <strong>efficiency</strong>, and <strong>long life</strong>. Explore our full range today and experience the energy that keeps homes lit, rides moving, and trust alive. Your power journey starts here.
						</p>
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1 col-sm-12">
						<div class="cta-wrap text-center">
							...
							<h3>
							Inverter, E-rickshaw, or automotive Oliver delivers strength, reliability, and performance in every battery.
							</h3>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-sm-12">
						...
						<p>
							Oliver Batteries is backed by trusted quality certifications that reflect our commitment to excellence, safety, and sustainability. Our products meet stringent industry standards, ensuring reliable performance and long-lasting power. Every battery is tested, approved, and certified so you can choose Oliver with complete confidence.
						</p>
					</div>
